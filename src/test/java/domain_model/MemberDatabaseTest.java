...
class MemberDatabaseTest {
    ...
    public void testLoadDatabase(){
        ...
        String birthDate = memberDatabase.getClubMembers().get(0).getBirthDate();
    ...
    public void testAddMemberToDatabase(){
        ...
        String actualBirthDate = memberDatabase.getClubMembers().get(0).getBirthDate();
